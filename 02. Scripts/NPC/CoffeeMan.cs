...
public class CoffeeMan : BaseNPC
{
    ...
    protected override void InitializeNPCData(int npcID)
    {
        ...
        InteractionEvent coffeeManInteraction = gameObject.GetComponent<InteractionEvent>();
        if (coffeeManInteraction == null)
        {
            coffeeManInteraction = gameObject.AddComponent<InteractionEvent>();
        }
