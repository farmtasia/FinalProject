...
public class BaseField : MonoBehaviour, IInteractable
{
    //public FieldInfo soil;
    ...
    public GameObject growthObj; // 작물 성장과정이 담긴 오브젝트(비트) = BeetGrowth
    ...
    {
        //seed = soil.seed;
        //seedAnimator = soil.seedAnimator;
        //growthObj = soil.growthObj;
        //seedSO = soil.seedSO;
    ...
    public void Growth()
    {
        Instantiate(growthObj, transform.position, transform.rotation, parentObj);
    }
}
