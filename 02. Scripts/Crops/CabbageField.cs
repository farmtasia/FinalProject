...
public class CabbageField : MonoBehaviour, IInteractable
{
    ...
    public GameObject cabbage; // 작물 성장과정이 담긴 오브젝트(양배추) =CropGrowth
    ...
    private IEnumerator DeactivateSeedAfterAnimation()
    {
        ...
        // soil.SetActive(false); // 필드 오브젝트 비활성화
        // beet.SetActive(true);  // 작물 오브젝트 활성화
    }

    //private void OnDestroy()
    //{
    //    Instantiate(cabbage, transform.position, transform.rotation);
    //}
