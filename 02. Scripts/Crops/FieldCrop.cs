...
public class FieldCrop : MonoBehaviour, IInteractable
{
    ...
    public GameObject beet; // 작물 성장과정이 담긴 오브젝트(비트) =CropGrowth
    ...
    public void Beet()
    {
        Instantiate(beet, transform.position, transform.rotation);
    }
}
